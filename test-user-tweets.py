...
headers = {
    ...
    'x-client-transaction-id': 'Mcp5Kbm70hgS4hkad8P4ytq18Sf7RnKeBtY1lEaw2tzC7AkvNY///3oZFhilhyjaGFzPEzWCuXhgrU1ROxPobfwp6TG+Mg',
...
params = {
    'variables': '{"userId":"866414443","count":20,"includePromotedContent":true,"withQuickPromoteEligibilityTweetFields":true,"withVoice":true}',
...
response = requests.get(
    'https://x.com/i/api/graphql/MdhoJlJzYWas9JNmFz7H3A/UserTweets',
    params=params,
    cookies=cookies,
    headers=headers,
)
